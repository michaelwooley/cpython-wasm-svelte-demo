...
var ASM_CONSTS = {
  3016: function() {out('hello from thread!')},  
 3042: function() {out('hello from thread again...')}
};
  ...
  function _emscripten_force_exit(status) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(3, 1, status);
...
var proxiedFunctionTable = [null,exitOnMainThread,pthreadCreateProxied,_emscripten_force_exit,_fd_write];
...
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 2848;
