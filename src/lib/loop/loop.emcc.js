var createLoopModule = (() => {
	var _scriptDir = import.meta.url;

	return function (createLoopModule) {
		createLoopModule = createLoopModule || {};
		...
		var Module = typeof createLoopModule != 'undefined' ? createLoopModule : {};
    ...
    @param {boolean=} dontAddNull */
		...
		var wasmBinaryFile;
		if (Module['locateFile']) {
			wasmBinaryFile = 'loop.emcc.wasm';
			if (!isDataURI(wasmBinaryFile)) {
				wasmBinaryFile = locateFile(wasmBinaryFile);
			}
		} else {
			// Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
			wasmBinaryFile = new URL('loop.emcc.wasm', import.meta.url).toString();
		}
		...
		return createLoopModule.ready;
	};
})();
export default createLoopModule;
